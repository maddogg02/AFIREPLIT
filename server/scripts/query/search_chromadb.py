#!/usr/bin/env python3
"""
Utility script to query the ChromaDB vector store using OpenAI embeddings.
Provides CLI access for diagnostics and quick fuzz searches.

Usage:
    python search_chromadb.py --query "guidance for male hair" --chroma_dir path/to/chroma_storage_openai
"""
